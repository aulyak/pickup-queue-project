...
<ul>
    ...
    <li>
        <p><strong>Application</strong> refers to ABC KIDS DRIVER APPS, the software program provided by the Company.
        </p>
    </li>
    <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
            &quot;Our&quot; in this Agreement) refers to ABC KIDS DRIVER APPS.</p>
    </li>
    <li>
...
<ul>
    {{-- <li>By visiting this page on our website: <a href="{{ route('login') }}" rel="external nofollow noopener"
            target="_blank">abckidsbrighton.id</a></li> --}}
    <li>By visiting this page on our website: <a href="{{ route('login') }}"
            rel="external nofollow noopener">abckidsbrighton.id</a></li>
</ul>
